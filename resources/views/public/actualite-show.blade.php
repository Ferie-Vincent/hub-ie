...
<div class="pb-24 bg-blanc-creme">
    <div class="max-w-3xl mx-auto px-6 pt-14">
        ...
        <a href="{{ route('actualites.index') }}" class="inline-flex items-center gap-2 text-sm text-gris-500 hover:text-vert-ivoire transition-colors mb-10 link-underline">
        ...
        <p class="text-lg font-semibold text-noir-profond/70 leading-relaxed mb-8 border-l-4 pl-5"
           style="border-color: hsl(var(--vert-ivoire));">
            {{ $article->excerpt }}
        </p>
        @endif
